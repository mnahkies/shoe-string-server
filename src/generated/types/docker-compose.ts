 ...
 *
 * Items: A string value in the list.
 */
...
export interface ContainerSpec {
  ...
  working_dir?: string
  /**
   * This interface was referenced by `ContainerSpec`'s JSON-Schema definition
   * via the `patternProperty` "^x-".
   */
  [k: string]: unknown
}
...
export interface WorkloadSpec {
  ...
  tty?: boolean | string
  /**
   * This interface was referenced by `WorkloadSpec`'s JSON-Schema definition
   * via the `patternProperty` "^x-".
   */
  [k: string]: unknown
}
...
export interface Schedule {
  ...
  /**
   * This interface was referenced by `Schedule`'s JSON-Schema definition
   * via the `patternProperty` "^x-".
   */
  [k: string]: unknown
}
